...
cmdIf: 'IF' expr 'THEN' cmd | expr 'Then' cmd 'ELSE' cmd;
...
expr: CTE OPREL expr | CTE OPAD expr | CTE | CTE OPMULT expr | ABPAR expr FPAR | IDENTIFIER OPREL expr | IDENTIFIER OPAD expr | IDENTIFIER OPMULT expr | IDENTIFIER OPLOG expr | exprBool;
exprBool: IDENTIFIER | CTE | ABPAR exprBool FPAR | IDENTIFIER OPREL IDENTIFIER |
CTE OPREL CTE | CTE OPREL IDENTIFIER | IDENTIFIER OPREL CTE;
